pipeline {
  ...
  stages {
    ...
    stage('Deploy Production') {
      ...
      steps {
        sh '''
          cp /opt/ekoru/secrets/ekoru-services/.env.prod ${WORKSPACE}/.env.prod
