...
const TRANSLATIONS: TranslationMap = {
  'errors.service_category_not_found': {
    [Language.ES]: "Categoría de servicio con slug '{slug}' no encontrada",
    [Language.EN]: "Service category with slug '{slug}' not found",
    [Language.FR]: "Catégorie de service avec le slug '{slug}' introuvable",
    [Language.PT]: "Categoria de serviço com slug '{slug}' não encontrada",
    [Language.DE]: "Service-Kategorie mit Slug '{slug}' nicht gefunden",
  },
  'errors.service_category_not_found_id': {
    [Language.ES]: "Categoría de servicio con id '{id}' no encontrada",
    [Language.EN]: "Service category with id '{id}' not found",
    [Language.FR]: "Catégorie de service avec l'id '{id}' introuvable",
    [Language.PT]: "Categoria de serviço com id '{id}' não encontrada",
    [Language.DE]: "Service-Kategorie mit ID '{id}' nicht gefunden",
  },
...
/**
 * I18N Service - Stateless language utilities for the serviceCategories subdomain
 *
 ...
 */
@Injectable()
export class I18nServiceCategoryService {
   ...
   *
   * @example
   * translate('errors.service_category_not_found', Language.EN, { slug: 'diseno-grafico' })
   * // → "Service category with slug 'diseno-grafico' not found"
   */
  translate(
    key: string,
    language: Language,
